...
If you have any issues, please reach out on any of the support channels listed on the Logboat website.
...
Enjoy!"#,
			...
			async fn update() -> Result<(), anyhow::Error> {
				let res = reqwest::Client::new()
					.get("https://api.github.com/repos/RivulusLive/logboat-desktop/releases/latest")
