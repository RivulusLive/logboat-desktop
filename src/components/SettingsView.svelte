...
<Popup show={showPopup}>
	...
	<button
		...
		on:click={() => invoke("show_settings_interface", { plugin: "us.rivul.logboat.sdPlugin" })}
	>
		Click here to launch Logboat account management and keyboard mapping configuration
	</button>
